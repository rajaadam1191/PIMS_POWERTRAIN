var mirage = function(t) {
    ...
    function c(t, e) {
        if (t)
            return $ < 8 && "style" === e ? t.style.cssText : "getAttribute"in t ? t.getAttribute(e) : t.attributes[e]
    }
    function h(t, e, r) {
        if (t) {
            if (!($ < 8 && "style" === e))
                return "setAttribute"in t ? t.setAttribute(e, r) : t.attributes[e] = r;
            t.style.cssText = r
        }
    }
    function l(t, e) {
        if (t) {
            if (!($ < 8 && "style" === e))
                return "removeAttribute"in t ? t.removeAttribute(e) : delete t.attributes[e];
            t.style.cssText = ""
        }
    }
    function f(t, e) {
    ...
    function _() {
        var t = {};
        try {
            void 0 !== window.innerWidth ? (t.width = window.innerWidth,
            t.height = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (t.width = document.documentElement.clientWidth,
            t.height = document.documentElement.clientHeight) : (t.width = document.getElementsByTagName("body")[0].clientWidth,
    ...
    function A() {
        return new Promise(function(t) {
            ...
            t(I().then(function(t) {
                ...
                return bt("Speedtest failed", t.message),
                St
            }))
        }
        )
        ...
        return new Promise(function(t, e) {
            ...
            r.onreadystatechange = function() {
                if (4 === r.readyState) {
                    ...
                    1223 === o && (o = 204),
                    200 === o ? t(L(n, i(), r)) : e(Error("Unexpected HTTP status: " + o))
                }
            }
            ,
            r.send()
    ...
    function x(t, e, r) {
        ...
        "function" == typeof t.slice)
            return t.slice(e, r);
        if (e < 0 ? (e += a) < 0 && (e = 0) : e > a && (e = a),
        r < 0 ? (r += a) < 0 && (r = 0) : r > a && (r = a),
        r < e && (r = e),
        0 === (n = r - e))
            return new Uint8Array(n);
        for (i = new DataView(t,e,n),
        o = new Uint8Array(n),
        s = 0; s < n; s++)
            o[s] = i.getUint8(s);
        return o.buffer
    ...
    function D(t, e) {
        ...
        try {
            ...
            (r = new (this.BlobBuilder || this.WebKitBlobBuilder || this.MozBlobBuilder)).append(t),
    ...
    function k(t, e) {
        ...
        this.byteLength = i + 4,
        this.data = r,
        this.loadStatus = this.data.status == k.state.LOAD_OK ? this.data.status : this.data.status + ":" + this.data.cache_status,
    ...
    function V(t) {
        ...
        this.supportsBinaryData_ && ("undefined" == typeof ArrayBuffer && (this.supportsBinaryData_ = !1),
        "undefined" == typeof URL && "undefined" == typeof webkitURL && "undefined" == typeof mozURL && (this.supportsBinaryData_ = !1),
        "undefined" == typeof Blob && "undefined" == typeof BlobBuilder && "undefined" == typeof WebKitBlobBuilder && "undefined" == typeof MozBlobBuilder && (this.supportsBinaryData_ = !1)),
        this.loadStrategy_ = this.supportsBinaryData_ ? this.loadArrayBuffer_ : this.loadDataUrls_
    }
    function F() {
        ...
        void 0 === window.Blob && void 0 === window.BlobBuilder && void 0 === window.WebKitBlobBuilder && void 0 === window.MozBlobBuilder && (this.supportsBinaryData_ = !1);
    ...
    var q = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}
      , G = function(t, e) {
        ...
        !function(e, r) {
            ...
            function g(t, e, n) {
                e.constructor === t.constructor && n === s && e.constructor.resolve === a ? d(t, e) : n === J ? (v(t, J.error),
                J.error = null) : void 0 === n ? y(t, e) : r(n) ? p(t, e, n) : y(t, e)
            }
            function _(e, r) {
            ...
            function y(t, e) {
                t._state === Y && (t._result = e,
                t._state = Q,
                0 !== t._subscribers.length && k(b, t))
            }
            function v(t, e) {
                t._state === Y && (t._state = X,
                t._result = e,
                k(m, t))
            }
            function w(t, e, r, n) {
            ...
            function b(t) {
                var e = t._subscribers
                  , r = t._state;
                if (0 !== e.length) {
                    for (var n = void 0, i = void 0, o = t._result, s = 0; s < e.length; s += 3)
                        n = e[s],
                        i = e[s + r],
                        n ? T(r, n, i, o) : i(o);
            ...
            function L(t, e) {
                ...
                this._enumerate(e),
                0 === this._remaining && y(this.promise, this._result))) : v(this.promise, C())
            }
            function C() {
            ...
            L.prototype._settledAt = function(t, e, r) {
                var n = this.promise;
                n._state === Y && (this._remaining--,
                t === X ? v(n, r) : this._result[e] = r),
      ...
      , tt = function() {
        var t = a();
        return "readyState"in document && "complete" === document.readyState && t.resolve({}),
        d(document, "readystatechange", function(e) {
            "readyState"in document && "complete" === document.readyState && t.resolve(e)
        }, !0),
        d(document, "DOMContentLoaded", function(e) {
            t.resolve(e)
        }, !0),
        t.promise
    }()
      , et = function() {
        var t = a();
        return "complete" === document.readyState && tt.then(t.resolve),
        d(window, "load", function(e) {
            t.resolve(e)
        }, !0),
        t.promise
    }()
    ...
    S.prototype.add = function(t) {
        var e;
        return this.tokens ? (this.tokens.add(t),
        this) : (e = this.array(),
        s(e, t) < 0 && e.push(t),
    ...
    S.prototype.remove = function(t) {
        var e, r;
        return this.tokens ? (this.tokens.remove(t),
        this) : (e = this.array(),
        (r = s(e, t)) >= 0 ? (e.splice(r, 1),
        this.element.className = e.join(" "),
        this) : void 0)
    }
    ,
    S.prototype.toggle = function(t) {
        return this.tokens ? (this.tokens.toggle(t),
        this) : (this.has(t) ? this.remove(t) : this.add(t),
        this)
    }
    ,
    S.prototype.array = function() {
        var t, e;
        return t = this.element.className.replace(/^\s+|\s+$/g, ""),
    ...
    j.prototype.whenReady_ = function(t) {
        return this.queue_ = this.queue_.then(R(t, this)),
        this.queue_
    }
    ,
    j.prototype.has_ = function(t) {
        var e = this.map_[t]
          , r = i();
        return e && e + j.DEFAULT_TTL < r ? (this.remove_(t),
        this.persist_(),
        !1) : !!e
    }
    ,
    j.prototype.reset_ = function() {
        try {
            ...
            this.sizeMap_ = {},
            this.sizeQueue_ = m(this.map_, function(t, e) {
                var r = {
                    key: e,
                    value: t
                };
                return this.sizeMap_[e] = r,
                r
    ...
    j.prototype.indexOf_ = function(t, e, r) {
        var n, i;
        return 0 === this.sizeQueue_.length || void 0 === t ? -1 : (e = e || 0,
        r = r || this.sizeQueue_.length,
        0 == (n = r - e) ? -1 : (i = n / 2 + e,
        i |= i,
        this.sizeQueue_[i].value < t ? this.indexOf_(t, e, i) : this.sizeQueue_[i].value > t ? this.indexOf_(t, i, r) : i))
    }
    ,
    j.prototype.add_ = function(t) {
        var e, r = this.sizeMap_[t];
        r ? (e = this.indexOf_(r.value),
        this.sizeQueue_.splice(e, 1)) : (r = {
            key: t
        },
        this.sizeMap_[t] = r),
        this.map_[t] = r.value = i() + this.offset_++,
        this.sizeQueue_.unshift(r),
        this.sizeQueue_.length > j.MAX_LENGTH && this.remove_(this.sizeQueue_[this.sizeQueue_.length - 1].key)
    }
    ,
    ...
    B.prototype.releaseImageSrc = function() {
        if (this.imageSrc_)
            try {
                Nt.revokeObjectURL(this.imageSrc_),
                this.imageSrc_ = null
            } catch (t) {
    ...
    H.prototype.storeStyleMutation = function() {
        ...
        "hidden" === this.image_.style.visibility && (this.image_.style.visibility = "",
        e = c(this.image_, "style")),
        "none" === this.image_.style.display && (this.image_.style.display = "",
        e = c(this.image_, "style"));
    ...
    H.isValidCandidate = function(t) {
        ...
        f(t, "cfstyle"),
        c(t, "style");
        return e && "data:" === e.slice(0, 5).toLowerCase() ? (h(t, "src", e),
        H.restoreStyle(t),
        !1) : ((r && e !== r || !e) && H.restoreStyle(t),
        "IMG" === t.nodeName && !!e && (null === r || "" === r || r === e))
    }
    ,
    H.restoreStyle = function(t) {
        var e, r = f(t, "cfstyle");
        t.style && (t.style.visibility = "",
        t.style.display = ""),
        e = c(t, "style"),
        r ? e ? h(t, "style", H.mergeInlineStyles(t)) : h(t, "style", r) : l(t, "style")
    }
    ,
    ...
    H.prototype.setDegradedSrc = function(t) {
        return new G(R(function(e) {
            this.restored_ ? e() : (this.restoring_ = !0,
            this.unwrap_(),
            this.restoring_ = !1,
            this.whenStateExpires_(e),
            h(this.image_, "src", t),
            this.image_.src = t,
            "" === this.getStyle() ? l(this.image_, "style") : h(this.image_, "style", this.getStyle()),
    ...
    H.prototype.restore = function() {
        return this.forcePreloadOnly_ ? this.restoredResult_.promise : (this.restoring_ = !0,
        this.unwrap_(),
        this.restoring_ = !1,
        this.restored_ = !0,
    ...
    H.prototype.isWithinViewport = function() {
        var t, e = _(), r = this.image_.getBoundingClientRect();
        return t = r.bottom < 0 ? r.bottom : r.top > e.height ? r.top - e.height : 0,
    ...
    H.prototype.expireState_ = function() {
        ...
        this.stateCallback_ && (t = this.stateCallback_,
        this.stateCallback_ = null,
        t())
    }
    ,
    H.prototype.entersViewport_ = function() {
        return new G(R(function(t) {
            if (this.isWithinViewport())
                return t();
            var e = R(function() {
                this.isWithinViewport() && (null !== this.parentTreeCheckInterval_ && (window.clearInterval(this.parentTreeCheckInterval_),
                this.parentTreeCheckInterval_ = null),
    ...
    H.prototype.parentTreeChanges_ = function() {
        ...
        return this.parentTreeCheckInterval_ = window.setInterval(R(function() {
            H.matchesParentTree(this.image_, this.parentTree_) || (this.parentTree_ = H.resolveParentTree(this.image_),
            window.clearInterval(this.parentTreeCheckInterval_),
            this.parentTreeCheckInterval_ = null,
            this.parentTreeChangesPromise_ = null,
            t.resolve())
        }, this), H.PARENT_TREE_POLL_INTERVAL),
    ...
    H.prototype.wrap_ = function() {
        this.requireProxy_ ? (this.proxy_ || (this.proxy_ = this.makeProxy()),
        this.image_ = this.proxy_) : this.wrapImage_()
    }
    ,
    ...
    V.prototype.load = function(t) {
        ...
        return null === this.timer_ && (this.timer_ = setTimeout(R(function() {
            ...
            this.map_ = {},
            this.timer_ = null,
            this.loadStrategy_(e, R(function(e, r, n, i) {
                t[e].resolve({
                    src: e,
                    width: n,
                    height: i,
                ...
                for (var r in t)
                    r in e || t[r].reject(new Error(r + " was not preloaded."))
            }, function(e) {
                for (var r in t)
                    t[r].reject(new Error("Fatal XHR failure." + (e ? " " + e.message : "")))
            })
        }, this), V.LOAD_TICK_INTERVAL)),
        e.promise
    }
    ,
    V.prototype.loadDataUrls_ = function(t, e, r) {
        ...
        o += t.reduce(function(t, e, r) {
            ...
            return void 0 !== rt && $ <= 8 && (i = t.length + n.length > 2032),
                ...
                for (var t = n.responseText; t && c < t.length; )
                    try {
                        !function() {
                            ...
                            c += n.stringLength,
                            s[n.src] = n,
                            n.isValid() ? n.resolveSrc().then(function(t) {
            ...
            if (t.length) {
                var e = m(t, function(t) {
                    var e = this.loader_.load(t.getSrc()).then(R(function(e) {
                        return this.logPreload(k.state.LOAD_OK),
                        (this.supportsBinaryData_ ? this.postProcess_(e.degradedSrc, e.width, e.height) : G.resolve(e.degradedSrc)).then(function(e) {
                        ...
                        return bt("Attempt to preload image failed.", e.message),
    ...
    F.prototype.activate = function() {
        return tt.then(R(function() {
            ...
            return t.length && t.length >= 1 && (this.requireProxy_ = this.accessorTest(t[0])),
            this.capture(),
            this.requireProxy_ && this.captureNativeMethods(),
            this.isHighLatency_().then(R(function(t) {
    ...
    F.prototype.postProcess_ = function(t, e, r) {
        return new G(function(n) {
            ...
            i.width = e,
            i.height = r,
            o.addEventListener("load", R(function() {
                s.drawImage(o, 0, 0, e, r),
                n(i.toDataURL())
            }, this)),
            o.addEventListener("error", R(function(t) {
                bt("Error loading image."),
                n("")
            }, this)),
            o.src = t
        }
    ...
    F.prototype.limitPreloadableImages_ = function(t) {
        ...
        return y(b(t, function(t) {
            ...
            var i = dt(t);
            n < Ct.maxdegradedimages ? (i || e.push(n),
            r.push(t)) : i && e.length > Ct.maxexternalimages && (r.splice(e.pop(), 1),
            r.push(t))
        }),
        G.resolve(r)
    }
    ...
    F.prototype.reducePreloadableImages_ = function() {
        ...
        G.all(t).then(R(function(t) {
            return this.limitPreloadableImages_(t).then(R(function(t) {
                ...
                n.length > 0 && window.setTimeout(function() {
                    y(n, function(t) {
                        t.restore()
                    })
