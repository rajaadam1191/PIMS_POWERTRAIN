<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="HR_Module.aspx.cs" Inherits="ProclainPIMSMaster.Form.HR_Module" %>
    ...
    <div class=" col-lg-7 reps" style="padding:15px">
                        ...
                        <div class="table100 ver6 m-b-110 table-responsive">
                            ...
                            <asp:GridView ID="SuggestionGridView" CssClass="form-control noticedt" runat="server" Style="background-color: none!important; display: table; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px; margin-bottom: 20px" BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Horizontal" CellSpacing="5" AutoGenerateColumns="false" OnRowDataBound="SuggestionGridView_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IdeaPostMember" HeaderText="ApprovedUser" />
                                    <asp:BoundField DataField="Amount" HeaderText="ApprovedUserAmt" />
                                    <%--<asp:BoundField DataField="BENBM" HeaderText="BEN-Rating" />
                                    <asp:BoundField DataField="BENBM" HeaderText="BEN-Rating" />--%>
        ...
        <div class=" col-lg-1 reps" style="padding:0px">
         <div class="rightside no-gutters" style="width: 100%;height: 100%;">
             <input id="ImproButton" class="form-control btns ImproButtonCls" style="height:50%;width:100%;color:white" type="button" value="Response" data-toggle="modal" data-target="#myModalImpIdeaForm" hidden/>
                 
             <%--</div>
             <div class="row">--%>
                 <input id="ReplyButton" class="form-control btns" style="height:50%;width:100%;color:white" type="button" value="Assigned To" data-toggle="modal" data-target="#fullHeightModalRight" hidden/>
