<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMaster.Master" AutoEventWireup="true" CodeBehind="TeamDetail.aspx.cs" Inherits="ProclainPIMSMaster.Form.TeamDetail" %>
...
<%--<div class="col-12 peer pX-40  h-100 bgc-white scrollable pos-r" style="min-width:320px; padding-top: 28px">--%>
         ...
         <div class="leftside no-gutters">
             ...
             <div class="row">
                <div class="col-sm-12">
                    ...
                    <asp:TextBox ID="TeamHeadTextBox" CssClass="form-control bor" Width="100%" Enable="true" placeholder="Team Manager" runat="server" ></asp:TextBox>
                    </div>
                </div>
             <br />
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-sm-12">
                    ...
                    <asp:TextBox ID="EmployeeIdTextBox" CssClass="form-control bor Emplidclass" placeholder="Employee Id" runat="server" AutoPostBack="false" onkeydown = "return tableInputKeyPress(event);"></asp:TextBox>
                     </div>
                     </div>
                     <br />
                     <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
                <div class="peer">
                 <asp:Button ID="Submit" CssClass="form-control bor btnss" Width="100%" BorderColor ="DodgerBlue"  runat="server" Text="Submit" OnClick="Submit_Click"  />
                        ...
                        <div class="table100 ver6 m-b-110 table-responsive">
                            ...
                            <asp:GridView ID="SuggestionGridView" CssClass="form-control noticedt" runat="server" Style="background-color: none!important; display: table; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px; margin-bottom: 20px" BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Horizontal" CellSpacing="5" AutoGenerateColumns="false" OnRowDataBound="SuggestionGridView_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="HeadID" HeaderText="TeamHead" />
