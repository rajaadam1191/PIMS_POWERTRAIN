<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManagerList.aspx.cs" Inherits="ProclainPIMSMaster.Form.ManagerList" %>
...
<%--<div class="col-12 peer pX-40  h-100 bgc-white scrollable pos-r" style="min-width:320px; padding-top: 28px">--%>
    ...
    <div class="col-lg-4 form-control" >
         <div class="leftside no-gutters">
             <center><h4 class="fw-300 c-grey-902 mB-30">Department Manager Records
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
                <div class="peer">
                 <asp:Button ID="Alter" CssClass="form-control bor" Width="100%" BorderColor ="DodgerBlue"  runat="server" Text="Alter" OnClick="Alter_Click"  />
   ...
   <%-- <div class="col-sm-2">
        ...
        <div class="col-sm-12">
                <div class="peer">
                 <asp:Button ID="Delete" CssClass="form-control bor " Width="100%" BorderColor ="DodgerBlue"  runat="server" Text="Delete" OnClick="Delete_Click"  />
                 </div>
                        <%--<div class="col-sm-2">
