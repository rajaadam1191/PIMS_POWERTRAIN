<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CommitteeEvaluvation.aspx.cs" Inherits="ProclainPIMSMaster.Form.New_Mail" %>
...
<%--<div class="col-12 peer pX-40  h-100 bgc-white scrollable pos-r" style="min-width:320px; padding-top: 28px">--%>
    ...
    <div class="col-lg-4 form-control" >
         <div class="leftside no-gutters">
             <div class=" row">
                 <div class="col-sm-10">
             <center><h4 class="fw-300 c-grey-902 mB-30">Committee Evaluvation
            ...
            <div class="row">
                 <div class="col-sm-4">
                    ...
                    <div class="col-sm-8">
                        <asp:TextBox ID="EmployeeIdTextBox" CssClass="form-control bor Emplidclass" placeholder="Employee Id" runat="server"   onkeydown="return tableInputKeyPress(event);" ></asp:TextBox>
              ...
              <div class="row">
                <div class="col-sm-4">
                    <label>Member Of</label><br />
                         ...
                         <div class="col-sm-8">
                    <asp:DropDownList ID="MemDesignationDDList" Cssclass="form-control js-example" runat="server" Width="100%"  AutoPostBack="False" AppendDataBoundItems="True">  
                        <asp:ListItem>--Select--</asp:ListItem>    
                        <asp:ListItem>HR</asp:ListItem>    
                        <asp:ListItem>Lean</asp:ListItem>    
                        <asp:ListItem>Production ABU</asp:ListItem>
                        <asp:ListItem>Production MBU</asp:ListItem>
                        <asp:ListItem>HSE</asp:ListItem>        
                        <asp:ListItem>Maintenance</asp:ListItem>
                    </asp:DropDownList>
                   <div id="Other">
                       <asp:TextBox ID="OthersTextBox" CssClass="form-control bor OthersTextBoxClass" Width="100%" Enable="true" placeholder="Mention IT" runat="server"></asp:TextBox>
                   </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12" style="padding-bottom:5px">
                <div class="peer">
                 <asp:Button ID="Submit" CssClass="form-control bor btnss" Width="100%" style="color:white" BorderColor ="DodgerBlue"  runat="server" Text="Submit" OnClick="Submit_Click" />
        ...
        <div class="row">
            <div class="col-sm-12" style="padding-bottom:5px">
                <div class="peer">
                 <asp:Button ID="UpdateButton" CssClass="form-control bor btnss" Width="100%" style="color:white" BorderColor ="DodgerBlue"  runat="server" Text="Delete" OnClick="UpdateButton_Click"/>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table100 ver6 m-b-110 table-responsive">
                            ...
                            <asp:GridView ID="SuggestionGridView" CssClass="form-control noticedt" runat="server" Style="background-color: none!important; display: table; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px; margin-bottom: 20px" BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Horizontal" CellSpacing="5" AutoGenerateColumns="false" OnRowDataBound="SuggestionGridView_RowDataBound">
                                <Columns>
                                    <asp:BoundField DataField="ComitteeID" HeaderText="ComitteeID" />
                                    <asp:BoundField DataField="EmpId" HeaderText="Employee ID" />
                                    <asp:BoundField DataField="Members" HeaderText="Members" />
                                    <asp:BoundField DataField="Department" HeaderText="Department" />
                                    <asp:BoundField DataField="ODepartment" HeaderText="ODepartment" />
                                    <asp:BoundField DataField="Remark1" HeaderText="Remark" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding:30px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input id="CommitteeIdText" class="form-control bor Committeeidclass" name="CommitteeIdText" placeholder="Committee ID"   type="text"  onkeydown="return CMtableInputKeyPress(event);"/>
   ...
   <script type="text/javascript" src="http://cdnjs.cloudflare.com/ajax/libs/json2/20130526/json2.min.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("[id*=MemDesignationDDList]").change(function () {
                ...
                if (($(this).val() != "Other")) {
                    //alert('Not Checked:' + textbox);
                    console.log("Not Checked" + $(this).val());
                    $('.OthersTextBoxClass').val("");
                    $('#Other').hide();
    ...
    <script>
        function tableInputKeyPress(e) {
            ...
            {   
                ...
                $.ajax({
                    url: 'CommitteeEvaluvation.aspx/Checking',
                    method: 'post',
    ...
    <%-- Commitee ID Search  --%>
     <script>
        function CMtableInputKeyPress(e) {
            ...
            {   
                var CMId = $('.Committeeidclass').val();
                if (CMId != "")
                    {
                    $.ajax({
                        url: 'CommitteeEvaluvation.aspx/CMChecking',
                        method: 'post',
                        contentType: "application/json; charset=utf-8",
                        async: true,
                        dataFilter: function (data) { return data;},
                        ...
                        success: function (data) {
                            ...
                            if (er != 1) {
                                ...
                                document.getElementById('<%= DepartmentTextBox.ClientID %>').value = data.d.Department;
                                document.getElementById('<%= DesignationTextBox.ClientID %>').value = data.d.Designation;
                                document.getElementById('<%= MemDesignationDDList.ClientID %>').value = data.d.Memberof;
                                console.log(data.d.Memberof);
                                if(oth=="Other")
                                {
                                    $("#Other").show();
                                    document.getElementById('<%= OthersTextBox.ClientID %>').value = data.d.Other;
                                    document.getElementById('<%= MemDesignationDDList.ClientID %>').value = data.d.Memberof;
                            ...
                            {
                                $("#Error").show();
                                document.getElementById('<%= ErrorLabel.ClientID %>').value = "Committee ID Does Not Exist";
                                $('.ErrorLabelClass').text("Committee ID Does Not Exist");
                ...
                return false; //return true to submit, false to do nothing
                    ...
                    $("#Error").show();
                                document.getElementById('<%= ErrorLabel.ClientID %>').value = "Search The Record By Entering CommitteeID ";
                    $('.ErrorLabelClass').text("Search The Record By Entering CommitteeID");
