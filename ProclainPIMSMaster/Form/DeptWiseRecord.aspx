<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="DeptWiseRecord.aspx.cs" Inherits="ProclainPIMSMaster.Form.DeptWiseRecord" %>
                        ...
                        <div class="masonry-item col-md-12 ">
                            ...
                            <asp:GridView ID="SuggestionGridView" CssClass="form-control noticedt" runat="server" Style="background-color: none!important; display: table; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px; margin-bottom: 20px" BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Horizontal" CellSpacing="5" AutoGenerateColumns="false" OnRowDataBound="SuggestionGridView_RowDataBound" >
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DBM" HeaderText="DBM" />
                                    <asp:BoundField DataField="Beneficiary" HeaderText="PHPVT_CODIR" />
                                    <asp:BoundField DataField="HOS" HeaderText="HOD" />
                                    <asp:BoundField DataField="HOD" HeaderText="Manager" />
                                    <asp:BoundField DataField="Committee" HeaderText="Committee" />
