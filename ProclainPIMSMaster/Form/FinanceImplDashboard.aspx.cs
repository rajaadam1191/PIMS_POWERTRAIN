...
{
    public class CESEmpEmailContentsimplfin
    {
    ...
    public partial class FinanceImplDashboard : System.Web.UI.Page
    {
        ...
        public void FinanceEvaluvationInsert()
        {
            ...
            try
            {
                ...
                MM.FinanceIMPLPayment(MM);

                string myscript = "alert ('Paid For Implement Members');";
                Response.Redirect("FinanceImplDashboard.aspx",false);
        ...
        protected void GetREportIndividual_Click(object sender, EventArgs e)
        {
            string IdeaID = IMPIdeaIdTextBox.Text.ToString();
            Response.Redirect("FinanceExcel.aspx?IdeaID="+ IdeaID); 
        }
    }
