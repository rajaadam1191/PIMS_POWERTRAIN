<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="RolesComments.aspx.cs" Inherits="ProclainPIMSMaster.Form.RolesComments" %>
                    ...
                    <div class="row">        
                        <div class="masonry-item col-md-12 ">
                            <div class="bd bgc-white p-20 cardintab reps">
                             ...
                             <asp:DropDownList  width="20%" Id="DepartmentDDList" cssClass="js-example form-control bor"  runat="server" AutoPostBack="false" AppendDataBoundItems="True" hidden="hidden">  
                            ...
                            <asp:GridView ID="SuggestionGridView" CssClass="form-control noticedt" runat="server" Style="background-color: none!important; display: table; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px; margin-bottom: 20px" BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Horizontal" CellSpacing="5" AutoGenerateColumns="false" OnRowDataBound="SuggestionGridView_RowDataBound" >
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DBMComm" HeaderText="DBM_COMM" />
                                    <asp:BoundField DataField="Comm" HeaderText="COMM" />
                                    <asp:BoundField DataField="DBMMan" HeaderText="DBM_MAN" />
                                    <asp:BoundField DataField="Man" HeaderText="MANAGER" />
                                    <asp:BoundField DataField="IMPL" HeaderText="IMPL_MEM" />
                                    <asp:BoundField DataField="HOD" HeaderText="HOD" />
                                    <asp:BoundField DataField="Ben" HeaderText="BEN" />
                                    <asp:BoundField DataField="FinEmp" HeaderText="FIN_EMP" />
                                    <asp:BoundField DataField="FinImpl" HeaderText="FIN_IMPL" />
