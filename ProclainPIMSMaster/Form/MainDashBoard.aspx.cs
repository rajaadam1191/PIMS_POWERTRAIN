...
namespace ProclainPIMSMaster.Form
{
    public partial class MainDashBoard : System.Web.UI.Page
    {
        ...
        int yrsuggestionreceived1, yraccepted1, yrreject1, yrsuggestionreceived2, yraccepted2, yrreject2, yrsuggestionreceived3, yraccepted3, yrreject3,
            yrsuggestionreceived4, yraccepted4, yrreject4, yrsuggestionreceived5, yraccepted5, yrreject5, yrsuggestionreceived6, yraccepted6, yrreject6,
            yrsuggestionreceived7, yraccepted7, yrreject7, yrsuggestionreceived8, yraccepted8, yrreject8, yrsuggestionreceived9, yraccepted9, yrreject9,
            yrsuggestionreceived10, yraccepted10, yrreject10;
        ...
        public void bindGraphNew()
        {
            try
            {
                ...
                yrsuggestionreceived2 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[3].ToString());
                yraccepted2 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[4].ToString());
                yrreject2 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[5].ToString());
                
                yrsuggestionreceived3 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[6].ToString());
                yraccepted3 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[7].ToString());
                yrreject3 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[8].ToString());
                
                yrsuggestionreceived4 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[9].ToString());
                yraccepted4 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[10].ToString());
                yrreject4 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[11].ToString());
                
                yrsuggestionreceived5 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[12].ToString());
                yraccepted5 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[13].ToString());
                yrreject5 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[14].ToString());
                
                yrsuggestionreceived6 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[15].ToString());
                yraccepted6 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[16].ToString());
                yrreject6 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[17].ToString());
                
                yrsuggestionreceived7 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[18].ToString());
                yraccepted7 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[19].ToString());
                yrreject7 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[20].ToString());
                
                yrsuggestionreceived8 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[21].ToString());
                yraccepted8 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[22].ToString());
                yrreject8 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[23].ToString());
                
                yrsuggestionreceived9 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[24].ToString());
                yraccepted9 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[25].ToString());
                yrreject9 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[26].ToString());
                
                yrsuggestionreceived10 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[27].ToString());
                yraccepted10 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[28].ToString());
                yrreject10 = int.Parse(Ds4.Tables[0].Rows[0].ItemArray[29].ToString());
